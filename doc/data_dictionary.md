...
Written by `fafnir actions add|delete|redate` and `fafnir prices delete|shift|rescale`;
undone by `fafnir override revoke` (migrations 0025, 0026). Active means
`revoked_at IS NULL`.
